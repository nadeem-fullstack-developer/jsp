...
<tr><td>SHG CODE</td><td>Group Name</td><td>State Name</td><td>Account </td><td>IFSC CODE</td></tr>
...
SHGMem b=regDAO.viewDeatil();
  List<SHGDTO> slist= b.getShgList();
   List<MemDTO> mlist= b.getMemList();
     ...
     {
   	 %>
   	 <tr bgcolor="cyan"><td><%=p.getShgCode()%></td>
   	 <td><%=p.getGname()%></td>
   	 <td><%=p.getStCode()%></td>
   	 <td><%=p.getAcc()%></td>
   	 <td><%=p.getIfsc()%></td>
   	 </tr> 
   	 <tr><td colspan="5" bgcolor="red"> CHILD DETAIL </td></tr>
    	
    	
    	<tr><td>Member Code</td><td>Name</td><td>Age</td><td>Adhar</td></tr>
