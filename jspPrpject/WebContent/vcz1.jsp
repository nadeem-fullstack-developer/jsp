...
try {
	...
	if (rs.next()) {
		out.println(
		"<html><body background='light_blue1.bmp'><form method=post action='czpro.jsp'><table><tr><td><font size=1>Citizen ID</td><td><input type=text size=15 name=cid value="
				+ cname + "></td></tr>");
		...
		+ rs.getString(12) + "></td>");
		out.println(
		"<td><font size=1>Vehicle Type </td><td><select name='utype'><option value='2'>2 Wheeler</option> <option value='4'>4 Wheeler</option><option value='HV'>Heavy Vehicle </option></select></td></tr></td></tr>");
		out.println("</table>");
		out.println(
		"<hr><table><tr><td><font size=1>Apply Passport <input type=radio name='r2' value='1' checked></td><td><font size=1>Apply License<input type=radio name='r2' value='2'></td></tr>");
