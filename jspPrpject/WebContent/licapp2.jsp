...
try {
	...
	out.println("<option> " + rs1.getString(1) + "</option>");
		...
		out.println(
		"<tr><td><font size=1>Venue</td><td><input type=text size=15 name=venue></td><td><font size=1>Report To</td><td><input type=text size=15 name=rto></td></tr>");
		out.println(
		"<tr><td><font size=1>Reporting Date</td><td><input type=text size=15 name=tdate></td><td><font size=1>Reporting Time</td><td><input type=text size=15 name=ttime></td></tr></table>");
