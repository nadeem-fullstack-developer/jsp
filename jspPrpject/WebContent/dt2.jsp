...
try {
	...
	if (rs.next()) {
		...
		if (rs.next()) {
	out.println(
			"<tr><td><font size=1>Venue</td><td><input type=text size=15 name=venue value=" + rs.getString(2)
					+ "></td><td><font size=1>Report To</td><td><input type=text size=15 name=rto  value="
					+ rs.getString(3) + "></td></tr>");
	out.println("<tr><td><font size=1>Reporting Date</td><td><input type=text size=15 name=tdate value="
			+ rs.getString(4)
			+ "></td><td><font size=1>Reporting Time</td><td><input type=text size=15 name=ttime value="
			+ rs.getString(5) + "></td></tr></table><p>");
	out.println(
			"<font size=1>Test Passed<input type=radio name='r1' value='Passed' checked> <font size=1>Test Failed<input type=radio name='r1' value='Failed'> ");
		}
